...
public   class App {
    ...
    public static void createPerson() {
        ...
        boolean parent_Permission = scanner.nextBoolean();
        scanner.nextLine();
        ...
        if (personType.equalsIgnoreCase("teacher")) {
            ...
            Teacher teacher = new Teacher(name, age, parent_Permission, specialization);
            people.add(teacher);
            System.out.println("Teacher created successfully.");
        } else if (personType.equalsIgnoreCase("student")) {
            Student student = new Student(name, age, parent_Permission);
            people.add(student);
